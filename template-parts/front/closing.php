...
$access_note      = (string) theme_option( 'shop_access_note', theme_demo_content( 'shop_access_note' ) );
$map_embed_url    = theme_option_url( 'shop_map_embed_url', theme_demo_content( 'shop_map_embed_url' ) );
	...
	<div class="wrap">
		<div class="cl_grid">
			...
			<div class="cl_acc reveal-r" id="access">
				...
				<div class="map"><?php if ( '' !== $map_embed_url ) : ?><iframe src="<?php echo esc_url( $map_embed_url ); ?>" width="600" height="450" style="border:0;" allowfullscreen loading="lazy" referrerpolicy="strict-origin-when-cross-origin" title="<?php echo esc_attr( 'アクセスマップ' ); ?>"></iframe><?php endif; ?></div>

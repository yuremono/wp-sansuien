						...
						<div id="col_main">
								<section>
										...
										<div id="c322" class="clearfix mv_it  js-hide mt0">
												<div>
														<h1 style="font-size:1em;"><?php theme_quests_lines( 'quests_hero_title', "Samplexx\nLayout Text Dummyxx" ); ?></h1>
												</div>
										</div><!-- #c322 -->
										...
										<div id="c266" class="Education bg100 child1680  mt0 bg_fix">
												...
												<div id="c326" class="clearfix txL">
														<article>
																<h3><em><?php theme_quests_text( 'quests_education_card_kicker', 'Education' ); ?></em><?php theme_quests_text( 'quests_education_card_heading', '文字文字' ); ?></h3>
										...
										<div id="c344" class="Education bg100 child1680  mt0 bg_fix">
												...
												<div id="c346" class="clearfix txR txwh">
														<article>
																<h3><em><?php theme_quests_text( 'quests_life_1_kicker', 'LIFE' ); ?></em><?php theme_quests_text( 'quests_life_1_heading', '文字のある文字' ); ?></h3>
										...
										<div id="c350" class="Education bg100 child1680  mt0 bg_fix">
												...
												<div id="c351" class="clearfix txR txwh">
														<article>
																<h3><em><?php theme_quests_text( 'quests_life_2_kicker', 'LIFE' ); ?></em><?php theme_quests_text( 'quests_life_2_heading', '文字のある文字' ); ?></h3>
										...
										<div id="c327" class="Education bg100 child1680 bg_fix">
												...
												<div  class="clearfix txL mt0 Germany">
														<article>
																<h3><em><?php theme_quests_text( 'quests_enjoy_kicker', 'Enjoy' ); ?></em><?php theme_quests_text( 'quests_enjoy_heading', '文字で遊ぶ' ); ?></h3>
												...
												<div id="c331" class="clearfix f40 PB1 pdi darken mt0">
														<div><span class='f140 lato lh13'><?php theme_quests_lines( 'quests_closing_big', "Sample text for layout\nbalance in this area\nthat keeps the original\nline volume" ); ?></span><br />
																<?php theme_quests_rich( 'quests_closing_small', 'ここにも仮の文字列を<span>同じ量だけ置きます。</span>' ); ?></div>
												</div><!-- #c331 -->

					...
					style="background-image: url(<?php echo esc_url( theme_source_uri( 'images/home/mv02__pc.jpg' ) ); ?>);background-color: var(--mc);">
						<div class="f_info">
								...
								<div class="form_01">
										<dl>
												<dt>所在地</dt>
												<dd><?php echo esc_html( $shop_postcode ); ?><br><?php echo esc_html( $shop_address ); ?></dd>
										</dl>
										<dl>
												<dt>TEL</dt>
												<dd><a href="<?php echo esc_url( theme_phone_uri( $shop_phone ) ); ?>"><?php echo esc_html( $shop_phone ); ?></a></dd>
										</dl>
										<dl>
												<dt>営業時間</dt>
						...
						<div class="f_map"><iframe src="<?php echo esc_url( $map_url ); ?>" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" title="<?php echo esc_attr( $shop_name . ' 地図' ); ?>"></iframe></div>
				</div>
				<nav class="f_nav">
						<?php
						wp_nav_menu(
